...
const Order = () => {
    ...
    return (
        ...
        <div className='font-mulish'>
            <Header />
            <div className='flex'>
                <div className='flex flex-col w-[50%] pl-[5%] bg-[#fbfcf9] border-t-2 border-b-2 dark:bg-black dark:border-t-1 dark:border-gray-500'>
                    <form>
                        <div className='mb-5 mt-5'>
                            <h1 className='px-3 py-4 tracking-wider font-extrabold text-2xl mb-1 dark:text-white'>Contact</h1>
                            <label for="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white ml-3" htmlFor="email">Email address</label>
                            <input type="email"
                                id="email"
                        ...
                        <div className='mb-8'>
                            ...
                            <label for="address" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white ml-3" htmlFor="address">Address</label>
                            <input type="text"
                                id="address"
                                className="bg-[#FFFFFF] h-11 border focus:outline-inherit border-black text-gray-900 text-sm rounded-sm focus:ring-blue-800 focus:border-none block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-black dark:focus:outline-none peer invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 px-5 w-[85%] ml-3  hover:border-blue-800"
                            ...
                            <div className='flex gap-2 mt-4'>
                                <label for="first" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white ml-3" htmlFor="first">First Name</label>
                                <label for="last" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white ml-[33%]" htmlFor="last">Last Name</label>
                            </div>
                            ...
                            <label for="city" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white ml-3" htmlFor="address">City</label>
                            <input type="text"
                                id="city"
                                className="bg-[#FFFFFF] h-11 border focus:outline-inherit border-black text-gray-900 text-sm rounded-sm focus:ring-blue-800 focus:border-none block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-black dark:focus:outline-none peer invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 px-5 w-[85%] ml-3  hover:border-blue-800"
                            ...
                            <label for="number" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white ml-3 mt-4" htmlFor="number">Phone Number</label>
                            <input type="text"
                                id="number"
                                className="bg-[#FFFFFF] h-11 border focus:outline-inherit border-black text-gray-900 text-sm rounded-sm focus:ring-blue-800 focus:border-none block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-black dark:focus:outline-none peer invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 px-5 w-[85%] ml-3  hover:border-blue-800"
                        ...
                        <div className='mb-8'>
                            ...
                            <button type="button" class=" flex text-white bg-[#050708] hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center justify-center items-center dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 me-2 mb-2 w-[85%] ml-[2%]">
                            ...
                            <button type="button" class="text-white bg-[#2557D6] hover:bg-[#2557D6]/90 focus:ring-4 justify-center focus:ring-[#2557D6]/50 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#2557D6]/50 me-2 mb-2 ml-[2%] w-[85%]">
                            ...
                            <button type="button" class="text-gray-900 bg-gray-200 hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none justify-center focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-800 dark:bg-white dark:border-gray-700 dark:text-gray-900 dark:hover:bg-gray-200 me-2 mb-2 ml-[2%] w-[85%]">
